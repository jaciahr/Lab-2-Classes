//Lab 2 - Classes
//Part 1
//Here you'll just implement the basic Vehicle class and its functions. 
//The class declaration will be written in Vehicle.h...
//...while the definitions of the functions will be written in Vehicle.cpp.

//Tests 1 and 2 are set up for you; you just need to write the Vehicle class for those. 
//For test 3, you will have to fill in the sections that are marked with a // TODO comment.
...
int main()
{
   ...
   else if (input == 5)
   {
      ...
      vehicles.push_back(muscleCar);// TODO: Add the three Vehicle objects to the vector using the push_back() function
...
//Part 2 
//The next class you're going to write and test is the Showroom. 
//This class will be storing Vehicle objects, so you can just bring in your code from Part 1 and reuse that here.
/*
#include "Vehicle.h"
#include "Showroom.h"
#include <iostream>
...
//Part 3 (complete?)
//In this part you will write the final class, the Dealership. 
//This classes utilizes both the Showroom and Vehicle class...
//...so be sure to have those completed first. main.cpp is provided for you.
